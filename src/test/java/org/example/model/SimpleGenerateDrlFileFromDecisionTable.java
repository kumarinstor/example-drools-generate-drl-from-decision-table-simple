...
public class SimpleGenerateDrlFileFromDecisionTable {
	...
	private static final String DECISION_TABLE_PATH = "src/main/resources/org/example/rules/";
	private static final String DECISION_TABLE_FILE = "ExampleDecisionTable.csv";
